  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-2">
          <p>space000에서 정한 특정 날짜/시간의 빈 슬롯에 팀 정보를 입력합니다.</p>
          <div className="bg-red-50 text-red-600 p-3 rounded-xl text-sm font-bold flex gap-2 items-start">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          <p>상대 팀이 신청을 수락하거나, 내가 보낸 신청이 수락되면 <strong>KakaoTalk</strong>으로 알림이 발송됩니다.</p>
          <p className="text-sm text-gray-500">space000 공식 채널을 통해 1차 매칭이 성사됩니다.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-3">
          <p>1차 매칭 후, 바로 만나기 전 서로의 정보를 더 알고 싶으신가요?</p>
          <div className="bg-brand-50 p-4 rounded-xl border border-brand-100">
            <span className="font-bold text-brand-800 block mb-1">🔍 사전 열람 옵션</span>
            <p className="text-sm text-brand-700">추가금을 지불하고 양 팀이 모두 동의하면 <strong>서로의 인스타그램 ID를 사전에 열람</strong>할 수 있습니다.</p>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-2">
          <p>예약된 시간에 <strong>space000 1층 라운지</strong>로 방문합니다.</p>
          <p>자체 제작된 아이스브레이킹 카드를 활용해 40분간 밀도 높은 대화를 나눕니다.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-400 font-bold">* 누가 Stop을 했는지는 상대방에게 공개되지 않습니다.</p>
        </div>
      )
    }
  ];
  ...
  return (
    <div className="p-8 md:p-16 max-w-3xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-black text-gray-900">상세 이용 프로세스</h2>
        <p className="text-gray-500">투명하고 체계적인 meet000만의 시스템</p>
      </div>
    ...
    <div className="p-0">
      ...
      <div className="h-[400px] relative">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-white text-center p-4">
          <h2 className="text-4xl md:text-5xl font-black mb-4">space000</h2>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {[
            ...
            <div key={i} className="bg-white p-6 rounded-2xl shadow-sm text-center border border-gray-100">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl font-bold mb-2 flex items-center gap-2">
                <Building2 className="text-brand-500" /> 1F : Cafe & Meeting Lounge
              </h3>
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 flex items-center gap-2">
                <Users2 className="text-brand-500" /> B1 : Dining & Rest
              </h3>
              <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {reviews.map((review, i) => (
              <div key={i} className="bg-white p-6 rounded-2xl shadow-sm relative">
                ...
                <p className="text-gray-700 font-medium mb-4 relative z-10 pt-4 leading-relaxed">
                  "{review.text}"
                </p>
                <div className="text-right">
                  <span className="text-sm font-bold text-gray-400">- {review.user}</span>
                </div>
              </div>
            ))}
          </div>
